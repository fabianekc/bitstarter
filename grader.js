...
var HTMLURL_DEFAULT = "http://cryptic-earth-6515.herokuapp.com/";
...
var cheerioHtmlUrl = function(htmlurl) {
    rest.get(htmlurl.toString()).on('complete', x=function(result) {
        if (result instanceof Error) {
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <html_url>', 'URL of index.html', clone(assertUrlExists))
        .parse(process.argv);
    if (program.file) {
